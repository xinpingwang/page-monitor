...
module.exports = function ([TOKEN, data]) {
  ...
  const md5 = (function () {
    ...
    function f(r, t) {
      ...
      for (f = 0; f < r.length; f += 16)
        (i = l),
          ...
          (h = d),
          (g = C),
          (l = u(l, v, d, C, r[f], 7, -680876936)),
          (C = u(C, l, v, d, r[f + 1], 12, -389564586)),
          (d = u(d, C, l, v, r[f + 2], 17, 606105819)),
          (v = u(v, d, C, l, r[f + 3], 22, -1044525330)),
          (l = u(l, v, d, C, r[f + 4], 7, -176418897)),
          (C = u(C, l, v, d, r[f + 5], 12, 1200080426)),
          (d = u(d, C, l, v, r[f + 6], 17, -1473231341)),
          (v = u(v, d, C, l, r[f + 7], 22, -45705983)),
          (l = u(l, v, d, C, r[f + 8], 7, 1770035416)),
          (C = u(C, l, v, d, r[f + 9], 12, -1958414417)),
          (d = u(d, C, l, v, r[f + 10], 17, -42063)),
          (v = u(v, d, C, l, r[f + 11], 22, -1990404162)),
          (l = u(l, v, d, C, r[f + 12], 7, 1804603682)),
          (C = u(C, l, v, d, r[f + 13], 12, -40341101)),
          (d = u(d, C, l, v, r[f + 14], 17, -1502002290)),
          (v = u(v, d, C, l, r[f + 15], 22, 1236535329)),
          (l = e(l, v, d, C, r[f + 1], 5, -165796510)),
          ...
          (v = e(v, d, C, l, r[f + 12], 20, -1926607734)),
          (l = o(l, v, d, C, r[f + 5], 4, -378558)),
          ...
          (v = o(v, d, C, l, r[f + 2], 23, -995338651)),
          (l = c(l, v, d, C, r[f], 6, -198630844)),
          (C = c(C, l, v, d, r[f + 7], 10, 1126891415)),
          (d = c(d, C, l, v, r[f + 14], 15, -1416354905)),
          (v = c(v, d, C, l, r[f + 5], 21, -57434055)),
          (l = c(l, v, d, C, r[f + 12], 6, 1700485571)),
          (C = c(C, l, v, d, r[f + 3], 10, -1894986606)),
          (d = c(d, C, l, v, r[f + 10], 15, -1051523)),
          (v = c(v, d, C, l, r[f + 1], 21, -2054922799)),
          (l = c(l, v, d, C, r[f + 8], 6, 1873313359)),
          (C = c(C, l, v, d, r[f + 15], 10, -30611744)),
          (d = c(d, C, l, v, r[f + 6], 15, -1560198380)),
          (v = c(v, d, C, l, r[f + 13], 21, 1309151649)),
          (l = c(l, v, d, C, r[f + 4], 6, -145523070)),
          (C = c(C, l, v, d, r[f + 11], 10, -1120210379)),
          (d = c(d, C, l, v, r[f + 2], 15, 718787259)),
          (v = c(v, d, C, l, r[f + 9], 21, -343485551)),
          (l = n(l, i)),
          (v = n(v, a)),
          (d = n(d, h)),
          (C = n(C, g));
    ...
    function g(n, r) {
      var t,
        ...
        o = [],
        c = [];
      for (o[15] = c[15] = void 0, e.length > 16 && (e = f(e, 8 * n.length)), t = 0; 16 > t; t += 1)
  ...
  function igonreChildren(elem) {
    ...
    return (
      ignoreChildrenElementReg.test(elem.tagName) ||
  ...
  function getRect(elem) {
    ...
    const x = Math.floor(rect.left + win.pageXOffset - html.clientLeft);
    const y = Math.floor(rect.top + win.pageYOffset - html.clientTop);
  ...
  function walk(elem) {
    ...
    if (elem.nodeType === 1) {
        ...
        if (node.name === "img") {
          ...
          for (let i = 0, len = elem.childNodes.length; i < len; i++) {
            ...
            if (filter(child, elem)) {
              // recursion
              const vdom = arguments.callee(child); //
      ...
      // text node
      const text = elem.nodeValue.trim();
      if (text) {
        node.name = "#";
        node.text = md5(text);
        return node;
